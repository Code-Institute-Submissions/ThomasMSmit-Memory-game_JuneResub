...
- Reset button in score board. Which is visible in the wireframes. There just wasn't enough time to get that future working after all the mayor changes that already had taken place.
...
- As the responsiveness did not work as intended at first, I decided to proceed with a mobile first approach in mind and adjusted the CSS according to the most common screen sizes.
...
- Description: There were no noticeable issues with this issue but after running it true the HTML validator this error came up.
...
- Description: Unnecessary use of class naming. Everything worked as intended after the fix was applied.

- Fixed: by deleting the HTML, body class and adding the values in it to the body class.

[JS hint](https://jshint.com/)

- Warnings: Undefined variables and missing semicolons

- Description: Issues such as missing semicolon and undefined variables came up when checking code with JS hint.
...
- Fixed: by removing the true value out of the function, the error was fixed. As the true value was obsolete in this instance.
